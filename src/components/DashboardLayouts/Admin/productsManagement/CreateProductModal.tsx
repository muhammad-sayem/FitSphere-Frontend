  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <button className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-white bg-primary-01 hover:bg-primary-01/80 rounded-xl transition-colors duration-200">
              ...
              {(field) => (
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onBlur={field.handleBlur}
                    onChange={(event) => field.handleChange(event.target.value)}
                    className="w-full rounded-2xl border border-secondary-03 bg-secondary-03/20 px-4 py-3 text-sm text-secondary-01 outline-none transition-colors focus:border-primary-01 focus:ring-2 focus:ring-primary-02/30 bg-white cursor-pointer appearance-none"
                  >
