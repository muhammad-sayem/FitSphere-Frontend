...
const TrainerCard = ({ trainer }: { trainer: ITrainerProps }) => {
  ...
  return (
    <div className="group relative w-full aspect-4/3 bg-neutral-100 border border-neutral-200 rounded-2xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-xl">
      ...
      <div className="absolute top-1/2 -translate-y-1/2 right-4 z-20 bg-white border border-neutral-200/80 rounded-xl px-2.5 py-6 shadow-md flex items-center justify-center">
        <span className="text-primary-01 text-xs font-black tracking-[0.25em] uppercase [writing-mode:vertical-lr] select-none">
          TRAINER
        </span>
      </div>
    </div>
